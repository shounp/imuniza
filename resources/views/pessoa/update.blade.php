        ...
        <div class="modal-body">
            <form action="{{ route('pessoa.update', $pessoa->id) }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input value="{{ $pessoa->nome }}" type="text" class="form-control" id="nome" aria-describedby="emailHelp" name="nome">
                </div>
                <div class="mb-3">
                    <label for="cpf" class="form-label">CPF</label>
                    <input value="{{ $pessoa->cpf }}" type="text" class="form-control" id="cpf" aria-describedby="emailHelp" name="cpf">
                </div>
                <div class="mb-3">
                    <label for="num_sus" class="form-label">NUMERO DO SUS</label>
                    <input value="{{ $pessoa->num_sus }}" type="text" class="form-control" id="numeor_sus" aria-describedby="emailHelp" name="numeor_sus">
                </div>
                <div class="mb-3">
                    <label for="data_nascimento" class="form-label">DATA DE NASCIMENTO</label>
                    <input value="{{ $pessoa->data_nascimento }}" type="text" class="form-control" id="data_nascimento" aria-describedby="emailHelp" name="data_nascimento">
                </div>
                <div class="mb-3">
                    <label for="nome_mae" class="form-label">NOME DA MÃE</label>
                    <input value="{{ $pessoa->nome_mae }}" type="text" class="form-control" id="nome_mae" aria-describedby="emailHelp" name="nome_mae">
                </div>
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="plano_saude">
                    ...
                    <div class="mb-3">
                        ...
                        <input value={{ $pessoa->endereco['cep'] }} type="number" maxlength="8" class="form-control" id="endereco" aria-describedby="emailHelp" name="endereco[cep]">
                    </div>
                    <div class="mb-3">
                        <label for="endereco" class="form-label">PAIS</label>
                        <input value={{ $pessoa->endereco['country'] }} type="text" maxlength="50" class="form-control" id="endereco" aria-describedby="emailHelp" name="endereco[country]">
                    </div>
                    <div class="mb-3">
                        <label for="endereco" class="form-label">CIDADE</label>
                        <input value={{ $pessoa->endereco['city'] }} type="text" maxlength="50" class="form-control" id="endereco" aria-describedby="emailHelp" name="endereco[city]">
                    </div>
                    <div class="mb-3">
                        <label for="endereco" class="form-label">ESTADO</label>
                        <input value={{ $pessoa->endereco['state'] }} type="text" maxlength="50" class="form-control" id="endereco" aria-describedby="emailHelp" name="endereco[state]">
                    </div>
                    <div class="mb-3">
                        <label for="endereco" class="form-label">BAIRRO</label>
                        <input value={{ $pessoa->endereco['district'] }} type="text" maxlength="50" class="form-control" id="endereco" aria-describedby="emailHelp" name="endereco[district]">
                    </div>
                    <div class="mb-3">
                        <label for="endereco" class="form-label">RUA</label>
                        <input value={{ $pessoa->endereco['street'] }} type="text" maxlength="50" class="form-control" id="endereco" aria-describedby="emailHelp" name="endereco[street]">
                    </div>
                    <div class="mb-3">
                        <label for="endereco" class="form-label">NUMERO</label>
                        <input value={{ $pessoa->endereco['number'] }} type="number" maxlength="5" class="form-control" id="endereco" aria-describedby="emailHelp" name="endereco[number]">
                    </div>
                    <div class="mb-3">
                        <label for="endereco" class="form-label">COMPLEMENTO</label>
                        <input value={{ $pessoa->endereco['complement'] }} type="text" maxlength="50" class="form-control" id="endereco" aria-describedby="emailHelp" name="endereco[complement]">
                    </div>
