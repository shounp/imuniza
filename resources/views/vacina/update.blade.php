        ...
        <div class="modal-body">
            <form action="{{ route('vacina.update', $vacina->id) }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" value={{ $vacina->nome }} maxlength="50" class="form-control" id="nome" aria-describedby="emailHelp" name="nome">
                </div>
                <div class="mb-3">
                    <label for="lote" class="form-label">LOTE</label>
                    <input type="number" value={{ $vacina->lote }} maxlength="11"  class="form-control" id="lote" aria-describedby="emailHelp" name="lote">
                </div>
                <div class="mb-3">
                    <label for="validade" class="form-label">DATA DE VALIDADE</label>
                    <input type="date" value={{ $vacina->validade }} class="form-control" id="validade" aria-describedby="emailHelp" name="validade">
                </div>
                <div class="mb-3">
                    <label for="doses" class="form-label">DOSES</label>
                    <input type="text" value={{ $vacina->doses }} maxlength="50" class="form-control" id="doses" aria-describedby="emailHelp" name="doses">
                </div>
                <div class="mb-3">
