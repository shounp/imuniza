        ...
        <div class="modal-body">
            <form action="{{ route('empresa.store') }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" maxlength="50" class="form-control" id="nome" aria-describedby="emailHelp" name="nome_empresa">
                </div>
                <div class="mb-3">
                    <label for="cnpj" class="form-label">CNPJ</label>
                    <input type="number" maxlength="11"  class="form-control" id="cnpj" aria-describedby="emailHelp" name="cnpj">
                </div>
                <div class="mb-3">
                    <label for="telefone" class="form-label">TELEFONE</label>
                    <input type="number" class="form-control" id="telefone" aria-describedby="emailHelp" name="telefone">
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">EMAIL</label>
                    <input type="text" class="form-control" id="data_nascimento" aria-describedby="emailHelp" name="email">
                </div>
                <div class="mb-3">
